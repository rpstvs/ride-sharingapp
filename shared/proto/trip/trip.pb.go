...
const file_trip_proto_rawDesc = "" +
	...
	"\bcarPlate\x18\x04 \x01(\tR\bcarPlate2\x91\x01\n" +
	"\vTripService\x12B\n" +
...
var file_trip_proto_depIdxs = []int32{
	...
	6,  // 11: trip.TripService.StartTrip:input_type -> trip.CreateTripRequest
	1,  // 12: trip.TripService.PreviewTrip:output_type -> trip.PreviewTripResponse
	7,  // 13: trip.TripService.StartTrip:output_type -> trip.CreateTripResponse
